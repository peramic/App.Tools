...
public class Defaults {
    ...
    private static boolean byteArraysToHexString = false;
   ...
   public static boolean isByteArraysToBase64() {
    ...
    /**
    * @return the byteArraysToHexString
    */
   public static boolean isByteArraysToHexString() {
       return byteArraysToHexString;
   }
   ...
   /**
    * @param byteArraysToHexString the byteArraysToHexString to set
    */
   public static void setByteArraysToHexString(boolean byteArraysToHexString) {
       Defaults.byteArraysToHexString = byteArraysToHexString;
   }
